...
import org22.example22.demo.bean.ResponseStandard;
import org22.example22.demo.core.EncryptionUtils;
import org22.example22.demo.core.JWTUtils;
import org22.example22.demo.core.MailUtils;
import org22.example22.demo.mapper.CrudUsersMapper;
...
public class LoginController {
    ...
    @Value("${pomxml.myvariable22}")
    private String pomxml_myvariable;
    @Value("${pomxml.jquery_variable}")
    private String jquery_variable;
    @Value("${pomxml.my_version}")
    private String my_version;
    @Value("${pomxml.my_java_home}")
    private String my_java_home;
    @Value("${pomxml.user_home}")
    private String user_home;
    @Value("${pomxml.env_variable}")
...
//        mailUtils.sendThymeleafHtmlMail(mailUserName, content);
    ...
    @RequestMapping(value="/testMaven", method = RequestMethod.GET)
    public void testMaven() {
        // maven 5种变量属性调用
        System.out.println(pomxml_myvariable);
        System.out.println(jquery_variable);
        System.out.println(my_version);
        System.out.println(my_java_home);
        System.out.println(user_home);
        System.out.println(env_variable);
    }
}
